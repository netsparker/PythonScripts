...
def issues_todo():
    ...
    endpoint_url = API_ROOT % "issues/todo"
    parser = argparse.ArgumentParser(description='Gets the list of to-do issues.')
    ...
    if (response.status_code == 200):
        ...
        with open('Issues_ToDo.json', 'w') as outfile:
        ...
        print("The issues list is saved into the 'Issues_ToDo.json' file.")
